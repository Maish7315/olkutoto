...
const DestinationDetail = () => {
  ...
  const destinations: Record<string, DestinationData> = {
    'maasai-mara-national-park': {
      ...
      images: [
        '/src/assets/mara/fece49bf-dafb-4893-8a54-68c9dab8ac8e.jpeg',
        '/src/assets/mara/Game drives in Samburu National Reserve-Kenya.jpeg',
        '/src/assets/mara/i-escape - Ultimate Wildlife (13 days, 12 nights)Cape Town, Hermanus, Winelands, Sabi Sand Game Reserve.jpeg',
        '/src/assets/mara/Nic Proust - Bush24 -The sun was setting in the….jpeg',
        '/src/assets/mara/Selous Game Reserve - Tanzania.jpeg',
        '/src/assets/mara/Thanda Safari Review_ The Perfect Bush Break in KZN.jpeg',
        '/src/assets/mara/This is to be seen in kenya, its the annual wild….jpeg',
        '/src/assets/mara/Ulusaba Rock Lodge - Sabi Sand Game Reserve (South Africa) - HIP Hotels.jpeg'
      ],
    ...
    'diani-beach-paradise': {
      ...
      images: [
        '/src/assets/diani/29 Colorful Coastal Living Decorating Inspirations.jpeg',
        '/src/assets/diani/5c9c1718-04b3-4fc0-bc7b-94665ad34622.jpeg',
        '/src/assets/diani/835bb76c-ceaa-4f23-a3ec-e27e8c8ab851.jpeg',
        '/src/assets/diani/Discover the Hidden Treasures of Sarasota, Florida_ A Day-by-Day Itinerary!.jpeg',
        '/src/assets/diani/SC.jpeg',
        '/src/assets/diani/Serene beach scene with gentle waves lapping at shore, palm trees swaying under bright s.jpeg'
      ],
    ...
    'tsavo-national-parks': {
      ...
      images: [
        '/src/assets/tsavo/East African Oryx or Beisa Oryx(Oryx beisa) at….jpeg',
        '/src/assets/tsavo/Embrace Unique Activities Beyond game drive in….jpeg',
        '/src/assets/tsavo/Explore Tarangire National Park In Tanzania.jpeg',
        '/src/assets/tsavo/Giraffes and sunset in Tsavo East and Tsavo West National Park stock photography.jpeg',
        '/src/assets/tsavo/Kenya Travel Guide – Parks, Best Time, Reviews & More!.jpeg',
        '/src/assets/tsavo/Plan to explore Tsavo West National Park and….jpeg',
        '/src/assets/tsavo/Safari in Kenya — BARBARA ATHANASSIADIS, Travel Writer.jpeg',
        '/src/assets/tsavo/Seeing Chimpanzees In The Wild At Gombe Stream National Park.jpeg',
        '/src/assets/tsavo/Serengeti National Park - National Park Field Guide.jpeg',
        '/src/assets/tsavo/There is no end to the adventures, we can have if….jpeg',
        '/src/assets/tsavo/WILDLIFE KENYA SAFARIS - DAY TRIPS (2025) All You Should Know BEFORE You Go (w_ Reviews) (1).jpeg',
        '/src/assets/tsavo/𝐖𝐡𝐞𝐫𝐞 𝐖𝐢𝐥𝐝𝐥𝐢𝐟𝐞 𝐌𝐞𝐞𝐭𝐬….jpeg',
        '/src/assets/tsavo/📌Watch animals from the aerial view of the….jpeg'
      ],
    ...
    'amboseli-national-park': {
      ...
      images: [
        '/src/assets/amboseli/2-Day Safari in Taita Hills from Mombasa.jpeg',
        '/src/assets/amboseli/9 PLACES TO PLAN YOUR VACATION IN KENYA 🔥.jpeg',
        '/src/assets/amboseli/Amboseli National Park Kenya 🇰🇪 Photo by….jpeg',
        '/src/assets/amboseli/Amboseli National Park travel.jpeg',
        '/src/assets/amboseli/An African Safari with Kids.jpeg',
        '/src/assets/amboseli/See things from a different perspective when you….jpeg',
        '/src/assets/amboseli/Spot the Big Five in Amboseli with Mt_ Kilimanjaro….jpeg',
        '/src/assets/amboseli/We have daily group departures to; ✓Amboseli….jpeg',
        '/src/assets/amboseli/🗓️ Day 2_ Tsavo East to Amboseli National Park –….jpeg'
      ],
    ...
    'lake-nakuru-national-park': {
      ...
      images: [
        '/src/assets/lake-nakuru/9-Day Luxury and Scenic Kenya Safari These safari….jpeg',
        '/src/assets/lake nakuru/A phenominal wonder of the World! The great….jpeg',
        '/src/assets/lake nakuru/Book and enjoy a 4-day getaway experience at the….jpeg',
        '/src/assets/lake nakuru/Can you guess the name of this enchanting lake….jpeg',
        '/src/assets/lake nakuru/f11a27ee-c19a-4586-80dd-a32abf256520.jpeg',
        '/src/assets/lake nakuru/Kenya wildlife safari Masai mara game reserve and Lake Nakuru national park_.jpeg',
        '/src/assets/lake nakuru/Kenya’s Lake Nakuru National Park_ A Photo Story of Wild Riches.jpeg',
        '/src/assets/lake nakuru/Lake Nakuru national park – The Birders’ Paradise.jpeg',
        '/src/assets/lake nakuru/Lake Nakuru National Park is one of the best….jpeg',
        '/src/assets/lake nakuru/Lake Nakuru National Park, Kenya.jpeg',
        '/src/assets/lake nakuru/Lake Nakuru.jpeg',
        '/src/assets/lake nakuru/Waterfall, Lake Nakuru National Park, Rift Valley, Nakuru County, Kenya.jpeg'
      ],
    ...
    'samburu-national-reserve': {
      ...
      images: [
        '/src/assets/samburu/10-Day Samburu, Nakuru, Masai Mara, Naivasha….jpeg',
        '/src/assets/samburu/11-Day Samburu,Ol Pejeta, Ark, Nakuru, Mara and….jpeg',
        '/src/assets/samburu/7 Days Samburu and Masai Mara Safari Itinerary Ideas.jpeg',
        '/src/assets/samburu/Honeymoon Breakfast - Picture of Sasaab, Samburu National Reserve - Tripadvisor.jpeg',
        '/src/assets/samburu/Rare Wildlife Wonders_ Discover Samburu\'s Unique Zebras and Giraffes_.jpeg',
        '/src/assets/samburu/Samburu -  national park.jpeg',
        '/src/assets/samburu/Samburu National Reserve Guide - Shaz On The Move.jpeg',
        '/src/assets/samburu/Samburu National Reserve – Travel Guide, Map & More!.jpeg',
        '/src/assets/samburu/SARUNI SAMBURU - Updated 2025 Prices &  Cottage Reviews (Kenya_Samburu National Reserve).jpeg',
        '/src/assets/samburu/Two Days in Samburu National Reserve.jpeg',
        '/src/assets/samburu/When you go on an African safari in Kenya and… (1).jpeg'
      ],
    ...
    'lamu-island-heritage': {
      ...
      images: [
        '/src/assets/lamu/an old photo of Shela 1967.jpeg',
        '/src/assets/lamu/Forodhani House — The Perfect Hideaway.jpeg',
        '/src/assets/lamu/Lamu highway - Kenya.jpeg',
        '/src/assets/lamu/Lamu Island, Kenya.jpeg',
        '/src/assets/lamu/Lamu Old Town (2025) - All You Need to Know BEFORE You Go (with Reviews).jpeg',
        '/src/assets/lamu/Lamu port - Kenya.jpeg',
        '/src/assets/lamu/Lamu, a small island off the coast of Kenya….jpeg',
        '/src/assets/lamu/Starfish.jpeg',
        '/src/assets/lamu/The 71 most beautiful places in the world (1).jpeg',
        '/src/assets/lamu/Woman hand with henna - Lamu Kenya.jpeg'
      ],
    ...
    'fort-jesus-museum': {
      ...
      images: [
        '/src/assets/fortjesus/Canon in Fort Jesus Mombasa - Visit Kenya.jpeg',
        '/src/assets/fortjesus/Fort Jesus in Mombasa, Kenya.jpeg',
        '/src/assets/fortjesus/Fort Jesus Kenya.jpeg',
        '/src/assets/fortjesus/Fort Jesus Mombasa, Kenya.jpeg',
        '/src/assets/fortjesus/Fort Jesus 📍Kenya 🇰🇪.jpeg',
        '/src/assets/fortjesus/Fort Jesus, Mombasa Kenya.jpeg',
        '/src/assets/fortjesus/Fort Jesus, Mombasa.jpeg',
        '/src/assets/fortjesus/FORT JESUS.jpeg',
        '/src/assets/fortjesus/Fort Jesus_.jpeg',
        '/src/assets/fortjesus/Fort Jésus, Mombasa_ Kenya.jpeg',
        '/src/assets/fortjesus/Kenya cruise port_ Mombasa.jpeg',
        '/src/assets/fortjesus/MOMBASA CITY DAY TOUR Explore the beautiful city….jpeg',
        '/src/assets/fortjesus/mombasa, kenya_ fort jesus museum.jpeg',
        '/src/assets/fortjesus/Today, our clients embarked on an unforgettable… (1).jpeg',
        '/src/assets/fortjesus/Today, our clients embarked on an unforgettable….jpeg'
      ],
